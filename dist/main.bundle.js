...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_ngx_quill_editor__ = __webpack_require__("../../../../ngx-quill-editor/index.js");
...
var Widget = /** @class */ (function () {
    function Widget(_id, widgetType, pageId, name, size, text, width, url) {
...
var WidgetText = /** @class */ (function () {
    function WidgetText(_id, widgetType, pageId, name, text, rows, placeholder, formatted) {
        this._id = _id;
        this.widgetType = widgetType;
        this.pageId = pageId;
        this.name = name;
...
var PageEditComponent = /** @class */ (function () {
    ...
    PageEditComponent.prototype.updatePage = function () {
        var _this = this;
        //console.log("updating");
        this.pageService.updatePage(this.curPage._id, this.curPage).subscribe(function (data) { return _this.router
            .navigate(['user/', _this.userId, 'website', _this.websiteId, 'page']); });
    };
    PageEditComponent.prototype.deletePage = function () {
        var _this = this;
        this.pageService.deletePage(this.curPage._id).subscribe(function (data) { return _this.router
            .navigate(['user/', _this.userId, 'website', _this.websiteId, 'page']); });
    };
...
var PageNewComponent = /** @class */ (function () {
    ...
    PageNewComponent.prototype.createPage = function (pageName, pageTitle) {
        var _this = this;
        var newPage = new __WEBPACK_IMPORTED_MODULE_3__models_page_model_client__["a" /* Page */](undefined, pageName, this.websiteId, pageTitle);
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.deleteUser = function () {
        var _this = this;
        this.userService.deleteUser(this.user._id).subscribe(function (status) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            return _this.userService.findUserById(userId).subscribe(function (user) {
                _this.user = user;
                //console.log(user);
            });
        });
...
var WebsiteEditComponent = /** @class */ (function () {
    ...
    WebsiteEditComponent.prototype.deleteWebsite = function () {
        var _this = this;
        this.websiteService.deleteWebsite(this.curWebsite._id).subscribe(function (data) { return _this.router.navigate(['user/', _this.userId, 'website']); });
    };
...
var WebsiteNewComponent = /** @class */ (function () {
    ...
    WebsiteNewComponent.prototype.createWebsite = function (webName, webDes) {
        var _this = this;
        var newWebsite = new __WEBPACK_IMPORTED_MODULE_1__models_website_model_client__["a" /* Website */](undefined, webName, this.userId, webDes);
    ...
    WidgetHeaderComponent.prototype.ngOnInit = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            ...
            if (params['wgid'] === undefined) {
                var widgetNew = new __WEBPACK_IMPORTED_MODULE_3__models_widget_model_client__["a" /* Widget */](undefined, 'HEADING', _this.pageId, '', 2, '', '', '');
...
var WidgetHtmlComponent = /** @class */ (function () {
    ...
    WidgetHtmlComponent.prototype.ngOnInit = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            ...
            _this.pageId = params['pid'];
            if (params['wgid'] === undefined) {
                var widgetNew = new __WEBPACK_IMPORTED_MODULE_3__models_widget_model_client__["a" /* Widget */](undefined, 'HTML', _this.pageId, '', 2, '', '', '');
                _this.widgetService.createWidget(_this.pageId, widgetNew).subscribe(function (widget) {
                    _this.widgetId = widget._id;
                    _this.widgetService.findWidgetById(_this.widgetId).subscribe(function (widget) {
                        _this.curWidget = widget;
...
var WidgetImageComponent = /** @class */ (function () {
    ...
    WidgetImageComponent.prototype.ngOnInit = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            ...
            _this.pageId = params['pid'];
            if (params['wgid'] === undefined) {
                var widgetNew = new __WEBPACK_IMPORTED_MODULE_2__models_widget_model_client__["a" /* Widget */](undefined, 'IMAGE', _this.pageId, '', undefined, '', '', '');
                _this.widgetService.createWidget(_this.pageId, widgetNew).subscribe(function (widget) {
                    _this.widgetId = widget._id;
                    //console.log(this.widgetId);
                    _this.widgetService.findWidgetById(_this.widgetId).subscribe(function (widget) {
...
var WidgetTextComponent = /** @class */ (function () {
    ...
    WidgetTextComponent.prototype.ngOnInit = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            ...
            _this.pageId = params['pid'];
            if (params['wgid'] === undefined) {
                var widgetNew = new __WEBPACK_IMPORTED_MODULE_3__models_widgetText_model_client__["a" /* WidgetText */](undefined, 'TEXT', _this.pageId, '', '', 1, '', false);
                _this.widgetService.createWidget(_this.pageId, widgetNew).subscribe(function (widget) {
                    _this.widgetId = widget._id;
                    _this.widgetService.findWidgetById(_this.widgetId).subscribe(function (widget) {
                        _this.curWidget = widget;
...
var WidgetYoutubeComponent = /** @class */ (function () {
    ...
    WidgetYoutubeComponent.prototype.ngOnInit = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            ...
            _this.pageId = params['pid'];
            if (params['wgid'] === undefined) {
                var widgetNew = new __WEBPACK_IMPORTED_MODULE_2__models_widget_model_client__["a" /* Widget */](undefined, 'YOUTUBE', _this.pageId, '', undefined, '', '', '');
                _this.widgetService.createWidget(_this.pageId, widgetNew).subscribe(function (widget) {
                    _this.widgetId = widget._id;
                    //console.log(this.widgetId);
                    _this.widgetService.findWidgetById(_this.widgetId).subscribe(function (widget) {
